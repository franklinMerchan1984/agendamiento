...
//java scrip puro
async function registrarUsuario(){//peticion request
  ...
  const request = await fetch('api/usuarios', {//request=variable//cuando se utiliza await debemos indicar a la funcion que es asincronica
    method: 'POST',
    headers: {
